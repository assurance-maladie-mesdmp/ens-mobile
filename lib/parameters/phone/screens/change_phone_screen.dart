...
class ChangePhoneScreen extends StatelessWidget {
  static const routeName = '/mon-compte/changement-telephone';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: StoreConnector<EnsState, ChangePhoneScreenViewModel>(
          converter: (store) => ChangePhoneScreenViewModel.fromEnsState(store),
          distinct: true,
          onWillChange: (_, vm) {
          ...
          onInitialBuild: (vm) {
            context.tagAction(TagsParameters.tag_compte_changement_telephone);
          },

...
class EnsPullToRefresh extends StatelessWidget {
                          ...
                          child: Container(
                            ...
                            child: OverflowBox(
                              ...
                              child: AnimatedContainer(
                                ...
                                alignment: Alignment.center,
                                decoration: const BoxDecoration(color: EnsColors.primary, shape: BoxShape.circle),
                                child: SizedBox(
                                  height: 30,
                                  width: 30,
                                  child: CircularProgressIndicator(
                                    strokeWidth: 2,
                                    valueColor: const AlwaysStoppedAnimation(EnsColors.light),

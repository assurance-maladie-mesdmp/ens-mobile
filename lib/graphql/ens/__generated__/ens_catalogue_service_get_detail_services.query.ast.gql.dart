...
const get_detail_service = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'get_detail_service'),
  variableDefinitions: [
    ...
    _i1.FieldNode(
      ...
      arguments: [
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'serviceId')),
        )
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
        _i1.FragmentSpreadNode(
          name: _i1.NameNode(value: 'detailService'),
          directives: [],
        )
      ]),
    )

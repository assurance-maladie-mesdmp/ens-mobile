...
const update_hospitalisation = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'update_hospitalisation'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'hospitalization')),
  ...
  selectionSet: _i1.SelectionSetNode(selections: [
    _i1.FieldNode(
      ...
      arguments: [
        _i1.ArgumentNode(
          name: _i1.NameNode(value: 'hospitalizationUpdateInput'),
          value: _i1.VariableNode(name: _i1.NameNode(value: 'hospitalization')),
        )
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
...
const document = _i1.DocumentNode(definitions: [update_hospitalisation]);

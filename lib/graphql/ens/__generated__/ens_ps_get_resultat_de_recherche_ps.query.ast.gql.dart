...
const get_resultat_de_recherche_professionnels_de_sante =
    _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name:
      _i1.NameNode(value: 'get_resultat_de_recherche_professionnels_de_sante'),
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'cityCode')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'departmentCode')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'professionCode')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'experticeCode')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.ObjectValueNode(fields: [
            ...
            _i1.ObjectFieldNode(
              ...
              value:
                  _i1.VariableNode(name: _i1.NameNode(value: 'departmentCode')),
            ),
            _i1.ObjectFieldNode(
              name: _i1.NameNode(value: 'cityCode'),
              value: _i1.VariableNode(name: _i1.NameNode(value: 'cityCode')),
            ),
            _i1.ObjectFieldNode(
              name: _i1.NameNode(value: 'professionCode'),
              value:
                  _i1.VariableNode(name: _i1.NameNode(value: 'professionCode')),
            ),
            _i1.ObjectFieldNode(
              name: _i1.NameNode(value: 'experticeCode'),
              value:
                  _i1.VariableNode(name: _i1.NameNode(value: 'experticeCode')),
            ),
          ]),
        )
      ],
...
const document = _i1.DocumentNode(
    definitions: [get_resultat_de_recherche_professionnels_de_sante]);

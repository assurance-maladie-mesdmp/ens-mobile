...
const create_contact = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'create_contact'),
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'fullName')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: true,
      ),
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'esId')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: true,
      ),
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.ObjectValueNode(fields: [
            ...
            _i1.ObjectFieldNode(
              ...
              value: _i1.VariableNode(name: _i1.NameNode(value: 'fullName')),
            ),
            _i1.ObjectFieldNode(
              name: _i1.NameNode(value: 'idFineg'),
              value: _i1.VariableNode(name: _i1.NameNode(value: 'esId')),
            ),
          ]),
        )
      ],
...
const document = _i1.DocumentNode(definitions: [create_contact]);

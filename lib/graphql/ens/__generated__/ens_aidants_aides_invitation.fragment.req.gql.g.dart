...
part of 'ens_aidants_aides_invitation.fragment.req.gql.dart';
...
class _$GinvitationReq extends GinvitationReq {
  ...
  factory _$GinvitationReq([void Function(GinvitationReqBuilder)? updates]) =>
      (new GinvitationReqBuilder()..update(updates))._build();
  ...
  _$GinvitationReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GinvitationReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        document, r'GinvitationReq', 'document');
    BuiltValueNullFieldError.checkNotNull(
        idFields, r'GinvitationReq', 'idFields');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GinvitationReq')
          ..add('vars', vars)
...
class GinvitationReqBuilder
  ...
  @override
  GinvitationReq build() => _build();

  _$GinvitationReq _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GinvitationReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

...
const get_as_suggestions = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'get_as_suggestions'),
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'typeSuggestion')),
      type: _i1.NamedTypeNode(
  ...
  selectionSet: _i1.SelectionSetNode(selections: [
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          name: _i1.NameNode(value: 'typeSuggestion'),
          value: _i1.VariableNode(name: _i1.NameNode(value: 'typeSuggestion')),
        ),
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
...
const document = _i1.DocumentNode(definitions: [get_as_suggestions]);

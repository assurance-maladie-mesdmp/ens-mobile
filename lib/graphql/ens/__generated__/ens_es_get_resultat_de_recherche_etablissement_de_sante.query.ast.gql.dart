...
const get_resultat_de_recherche_etablissements_de_sante =
    _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name:
      _i1.NameNode(value: 'get_resultat_de_recherche_etablissements_de_sante'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable:
          _i1.VariableNode(name: _i1.NameNode(value: 'searchStructureInput')),
...
const document = _i1.DocumentNode(
    definitions: [get_resultat_de_recherche_etablissements_de_sante]);

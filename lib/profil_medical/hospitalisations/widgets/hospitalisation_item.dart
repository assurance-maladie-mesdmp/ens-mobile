...
class HospitalisationItem extends StatelessWidget {
  final EnsHospitalisation hospitalisation;
  final void Function() onTap;

  const HospitalisationItem({
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(hospitalisation.name, style: EnsTextStyle.text16_w700_normal_title),
                  const SizedBox(height: 8),
                  Text(
                    EnsProfilMedicalDateUtils.formatTimeAndDurationForAdmission(
                      hospitalisation.startDate,
                      hospitalisation.duration,
                    ),
                    style: EnsTextStyle.text14_w400_normal_body,
                  ),
                  if (hospitalisation.linkedDocumentsIds.isNotEmpty)
                    Padding(
                      padding: const EdgeInsets.only(top: 8),
                      child: LinkedEntitieIndicator(
                        indicatorNumber: hospitalisation.linkedDocumentsIds.length,

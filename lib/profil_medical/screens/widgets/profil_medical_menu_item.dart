...
class ProfilMedicalMenuUniqueItem extends StatelessWidget {
  final String title;
...
class ProfilMedicalBlocMenu extends StatelessWidget {
  final String menuTitle;
  final String svgPath;
  final double svgHeight;
  final double svgWidth;
  final List<ProfilMedicalSubMenuItem> subMenuItems;

  const ProfilMedicalBlocMenu({
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(child: Text(menuTitle, style: EnsTextStyle.text14_w600_normal_title)),
              ],
            ),
          ),
          Padding(
...
class ProfilMedicalSubMenuItem extends StatelessWidget {
  final String title;
  final String destinationPage;
  final void Function()? onTap;
            ...
            children: [
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Expanded(child: Text(title, style: EnsTextStyle.text14_w700_normal_title)),

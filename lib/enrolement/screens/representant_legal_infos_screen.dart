...
class RepresentantLegalInfosScreen extends StatelessWidget {
  static const routeName = '/enrolement/infos_representant_legal';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ScrollviewWithScrollbar(
          padding: const EdgeInsets.only(top: 32, right: 24, left: 24, bottom: 54),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              const Text(
                'Qui est le représentant légal d\'un mineur ?',

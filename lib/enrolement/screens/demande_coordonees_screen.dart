...
class DemandeCoordonneesScreen extends StatelessWidget {
  static const routeName = '/enrolement/sans_coordonnees/demande_coordonnees';

  const DemandeCoordonneesScreen();
